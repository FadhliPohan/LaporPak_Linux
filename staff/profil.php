...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary">
            <h6 class="m-0 font-weight-bold text-light">Form Profil User</h6>
        </div>
        <div class="card-body">
            ...
            <form action="update/profil.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-1">
                        <img class="img-profile rounded-circle " src="../assets/img/foto/<?= $foto ?>" alt="Image-<?= $foto ?>" style="position:absolute;width:120px;height:120px;">
                    </div>
                </div>
