                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <?php
                            $data_diterima = mysqli_query($konek, "SELECT d.*, u.*, cb.*, p.* FROM detail_laporan d JOIN penyidikan p JOIN user u join cek_berkas cb WHERE d.id_user = u.id_user and d.no_tiket=cb.no_tiket and d.no_tiket = p.no_tiket and id_pengerjaan ='2'and cb.cek_id=1 and cb.cek_berkas=1 AND cb.cek_laporan=1 group by d.id_detail_laporan DESC");
