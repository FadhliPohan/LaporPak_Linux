        ...
        <div class="card-body">
            ...
            <form action="add/tugas.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-4">
                        ...
                        <select name="id_penerima" id="id_penerima" class="form-control">
                            ...
                            ?>
                                <option value="<?php echo $row4['id_admin']; ?>"><?php echo $row4['nama']; ?></option>';
                            <?php } ?>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="6" name="catatan_surat" class="form-control" id="icatatan_surat" placeholder="Berikan Catatan Untuk Staff!" value=""></textarea>
