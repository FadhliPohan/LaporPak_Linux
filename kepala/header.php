    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php if ($page == "masuk") {
                ...
                <a class="nav-link collapsed" herf="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item <?php if ($page == "diterima") {
                                    echo "active";
                                } elseif ($page == "ditolak") {
                                    echo "active";
                                } elseif ($page == "verifikasi") {
                                    echo "active";
                                } elseif ($page == "blmverifikasi") {
                                    echo "active";
                                } else {
                                    echo "";
                                } ?>">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php if ($page == "blmverifikasi") echo "active"; ?>" href="kerja-blmdiverifikasi.php">Laporan Belum Diverifikasi </a>
                    </div>
                </div>
            </li>
