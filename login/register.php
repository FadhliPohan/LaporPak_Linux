                        ...
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="text" name="no_tlp" id="no_tlp" class="form-control form-control-user" placeholder="Nomor yang aktif" maxlength="13" value="">

                                    </div>
                                </div>
                                <a href="proses_register.php" class="btn btn-primary btn-user btn-block">
                                    Buat Akun
                                </a>
                                <!-- <hr>
