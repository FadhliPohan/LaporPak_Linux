...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="add/klasifikasi.php" method="POST" enctype="multipart/form-data">

                <div class="form-group row">
                    <label for="JenisKlasifikasi" class="col-sm-2 col-form-label">Jenis Klasifikasi</label>
                    <div class="col-sm-10">
                        <input type="text" name="nama_masalah" class="form-control" id="JenisKlasifikasi" placeholder="Harap Jenis Klasifikasi Kejahatan" value="" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="6" name="deskripsi" class="form-control" id="deskripsi" placeholder="Harap isikan deskripsi jenis klasifikasi dengan lengkap!" value="" required></textarea>
