...
<head>
    ...
    <title>LaporPak - SuperAdmin Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php if ($page == "staff") {
                                    echo "active";
                                } elseif ($page == "kepala") {
                                    echo "active";
                                } elseif ($page == "user") {
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">User Admin:</h6>
                        <a class="collapse-item <?php if ($page == "staff") echo "active"; ?>" href="tbl_staff.php">Staff</a>
                        <a class="collapse-item <?php if ($page == "kepala") echo "active"; ?>" href="tbl_kepala.php">Kepala</a>

                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Other User:</h6>
                        <a class="collapse-item <?php if ($page == "user") echo "active"; ?>" href="tbl_user.php">Pelapor / User</a>
                        <a class="collapse-item <?php if ($page == "su") echo "active"; ?>" href="tbl_su.php">Super Admin</a>
                    </div>
                </div>
            </li>
