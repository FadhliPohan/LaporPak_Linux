...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2021 at 10:08 AM
...
INSERT INTO `laporan` (`id_lapor`, `id_detail_lapor`, `id_tindakan`, `id_status`, `tanggal_selesai`, `id_staff`, `id_kepala`) VALUES
(1, 1, 1, 3, '0000-00-00', 3, 4);
...
INSERT INTO `user` (`id_user`, `nama`, `jenis_kelamin`, `NIK`, `alamat`, `tmp_lahir`, `tgl_lahir`, `agama`, `pekerjaan`, `foto`) VALUES
(1, 'putri', 'permpuan', 123432342, 'palembang jl.srimulyani no.3', 'lahat', '2021-11-02', 'islam', 'Mahasiswa', 'putri.jpg'),
(2, 'rahmat', 'laki-laki', 43211122, 'palembang jl.srimulyani no.3', 'pekan baru', '2021-11-09', 'islam', 'mahasiswa', 'rahmat.jpg'),
(3, 'fadli', 'laki-laki', 42352345, 'medan, padang sidempuan no.8', 'bontang', '2021-11-02', 'islam', 'polisi', 'fadli.jpg'),
(4, 'rizki', 'laki-laki', 635465634, 'sumatra barat, jl.kesampingan no.2', 'padang', '2021-11-11', 'islam', 'aktor', 'rizki.jpg');
